...
// JavaScript Document
        ...
        const imageData = [
            {
                title: "gradient-ui-ux-elements-collection",
                description: "A modern collection of gradient-based UIUX elements designed for seamless integration into web and mobile applications."
            },
            {
                title: "application- Learn-languages",
                description: "Offers lessons and units with easy progress tracking"
            },
            {
                title: "Course-app",
                description: "An online learning app that offers various Courses To improve your skills"
            },
            {
                title: "Foodly",
                description: "An app that helps you easily and quickly order healthy meals from your favorite restaurants"
            },
            {
                title: "Violet-public-transport-mobile",
                description: "An app to book bus tickets and track trip schedules easily"
            },
            {
                title: "Meditation App",
                description: "Provides meditation sessions for better mental relaxation"
            },
            {
                title: "Learning Guide",
                description: "A project designed to provide a simplified guide for learning UI/UX design"
            }
        ];
